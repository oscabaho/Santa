...
namespace Santa.Infrastructure.Combat
{
    ...
    public class Movement : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
#if UNITY_EDITOR || DEVELOPMENT_BUILD
                GameLog.LogWarning($"No Animator found on {gameObject.name} or its children. Animations will not work.", this);
#endif
            }
        }
        ...
        private void Update()
        {
            ...
            if (_animator != null)
            {
                float currentSpeed = desiredMoveDirection.magnitude * moveSpeed;
